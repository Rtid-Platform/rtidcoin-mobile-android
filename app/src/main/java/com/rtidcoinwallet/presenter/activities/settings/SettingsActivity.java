...
import com.rtidcoinwallet.presenter.activities.CurrencySettingsActivity;
...
import com.rtidcoinwallet.presenter.entities.BRSettingsItem;
import com.rtidcoinwallet.tools.adapter.SettingsAdapter;
...
//        }, false, R.drawable.chevron_right_light));
        ...
        items.add(new BRSettingsItem(getString(R.string.Settings_review), "", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent appStoreIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id=com.rtidcoinwallet"));
                    appStoreIntent.setPackage("com.android.vending");

                    startActivity(appStoreIntent);
                } catch (android.content.ActivityNotFoundException exception) {
                    startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=com.rtidcoinwallet")));
                }
                overridePendingTransition(R.anim.enter_from_right, R.anim.exit_to_left);
            }
