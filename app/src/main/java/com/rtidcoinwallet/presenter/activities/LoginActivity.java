...
import com.rtidplatform.APIClient;
import com.google.firebase.analytics.FirebaseAnalytics;


import java.util.List;

import static com.rtidcoinwallet.R.color.white;
import static com.rtidcoinwallet.tools.util.BRConstants.PLATFORM_ON;
import static com.rtidcoinwallet.tools.util.BRConstants.SCANNER_REQUEST;
...
//                chooseWordsSize(true);
                ...
                public void onClick(View v) {
                    AuthManager.getInstance().authPrompt(LoginActivity.this, "", "", false, true, new BRAuthCompletion() {
                        ...
                        public void onComplete() {
                            ...
                            RtidcoinApp.getFirebaseInstance().logEvent(FirebaseAnalytics.Event.LOGIN,params);
                            unlockWallet();
                        }
        ...
        RtidcoinApp.addOnBackgroundedListener(new RtidcoinApp.OnAppBackgrounded() {
            @Override
